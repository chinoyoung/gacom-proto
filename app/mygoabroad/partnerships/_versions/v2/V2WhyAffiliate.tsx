...
import { AFFILIATE_DEMO, affiliateItems } from "../v1/constants";

export default function V2WhyAffiliate() {
  return (
    <section
      id="affiliate"
      aria-labelledby="why-affiliate-heading"
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-16 mb-12">
          ...
          <div className="w-full md:w-72 shrink-0 flex items-start justify-center">
            <img
              ...
              alt="Illustration of a community of partners"
