...
export default function V1ProviderRecognitions({ provider }: { provider: Provider }) {
  return (
    <div>
      <h2 className="text-2xl font-bold text-slate-900">Recognitions & Awards</h2>
      ...
      <div className="flex gap-4 overflow-x-auto pb-2 sm:grid sm:grid-cols-4 lg:grid-cols-6 sm:overflow-visible sm:pb-0">
        {BADGES.map((src, i) => (
          <div key={i} className="flex w-28 shrink-0 items-center justify-center rounded-md border border-slate-200 bg-white p-3 sm:w-auto">
            <img
              src={src}
