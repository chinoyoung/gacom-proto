...
import {
  interviewInitials,
  interviewAvatarClasses,
} from "@/app/programs/[id]/_versions/v1/interview-presentation";
...
export default function V1ProviderInterviews({ providerName }: { providerName: string }) {
  const interviews = useQuery(api.providers.listInterviewsByProvider, {
    providerName,
  });
  ...
  return (
    <section id="interviews" className="mx-auto w-full max-w-7xl px-4 xl:px-0">
