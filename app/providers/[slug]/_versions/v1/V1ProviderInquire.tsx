  ...
  return (
    <section aria-labelledby={headingId}>
      ...
      <h2 id={headingId} className="text-3xl font-bold tracking-tight text-neutral-800 mb-2">
        Inquire about {provider.name}
      </h2>
      <p className="text-base leading-relaxed text-slate-600 mb-10">
        Have a question? Send us a message and the {provider.name} team will get back to you.
      </p>
              ...
              {currentStep === 2 && (
                <div className="flex flex-col">
                  ...
                  <textarea
                    ...
                    placeholder="What would you like to know about their programs?"
