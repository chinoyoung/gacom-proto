...
import V2ReviewSummary from "../v2/V2ReviewSummary";
...
export default function V1Reviews({
  programId,
  reviews,
  ...
  // Live stats from Convex — drives V2ReviewSummary
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Summary block — V2ReviewSummary replaces v5's old summary card */}
      {stats && (
        <V2ReviewSummary
          stats={stats}
          provider={provider}
