          ...
          {tiles.map((src, i) => {
            ...
            return (
              <button
                ...
                className="relative w-16 h-16 rounded-md overflow-hidden cursor-pointer hover:opacity-90 transition-opacity shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cobalt-500 focus-visible:ring-offset-1"
                aria-label={
                  isOverflowTile
