      ...
      <div className="max-w-7xl mx-auto px-4 xl:px-0 pt-6 pb-6">
        ...
        <nav aria-label="Breadcrumb">
          ...
          <ol className="hidden sm:flex items-center gap-1.5 text-sm text-slate-500 flex-wrap">
            ...
            <li>
              <Link href="/programs" className="hover:text-cobalt-600 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cobalt-500 rounded">
                Programs
              </Link>
            </li>
            <li aria-hidden="true" className="text-slate-300">/</li>
