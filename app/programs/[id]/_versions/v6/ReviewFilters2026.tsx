...
// ── Re-export so Reviews2026Section can import from one place ─────────────────
...
interface ReviewFilters2026Props {
...
export default function ReviewFilters2026({
  topicTags,
  totalReviews,
  selectedTopic,
  onSelectTopic,
