    ...
    if (allPrograms === undefined) {
        return (
            <section className="mt-16 pt-16 border-t border-gray-200">
                <h2 className="text-2xl font-bold text-slate-900 mb-5">Related Programs</h2>
    ...
    return (
        <section className="mt-16 pt-16 border-t border-gray-200 pb-12">
            <div className="max-w-7xl mx-auto">
                <h2 className="text-2xl font-bold text-slate-900 mb-5">Other Programs You Might Like</h2>
